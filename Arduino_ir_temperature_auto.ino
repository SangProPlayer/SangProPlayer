#include <Wire.h>
#include <SD.h>                 // cho thẻ SD
#define SD_ChipSelectPin 10     // cho thẻ SD
#include <TMRpcm.h>             // Lib để phát tệp wav
#include <Adafruit_MLX90614.h>  // cho nhiệt kế hồng ngoại
//-------------------------------------- oled
#include "SSD1306Ascii.h"
#include "SSD1306AsciiAvrI2c.h"
#define I2C_ADDRESS 0x3C  // 0X3C+SA0 - 0x3C or 0x3D
#define RST_PIN -1  // Xác định RST_PIN thích hợp nếu được yêu cầu.
//--------------------------------------- oled
Adafruit_MLX90614 mlx = Adafruit_MLX90614();  //cho nhiệt kế hồng ngoại
SSD1306AsciiAvrI2c oled;  // tạo một đối tượng cho LCD
TMRpcm tmrpcm;            // tạo một đối tượng cho máy nghe nhạc
